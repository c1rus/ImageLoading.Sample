    ...
    public class ImageFragment : Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            ImageService.LoadUrl(urlToImage)
                .Retry(3, 200)
                .DownSample(300, 300)
                .LoadingPlaceholder(Config.LoadingPlaceholderUrl, ImageSource.Url)
                .ErrorPlaceholder(Config.ErrorPlaceholderUrl, ImageSource.Url)
            ...
            //ImageService.LoadFileFromApplicationBundle("Images/error.jpg").Into(imgDisplay);
